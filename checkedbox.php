...
<head>
    <title>Multipal Checked Box</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    <div class="list-group">
                                        <label class="list-group-item">
                                            <input class="form-check-input me-1" type="checkbox" name="furits[]" value="apple" <?php CheckedInput('furits', 'apple') ?> />
                                            Apple
                                        </label>
                                        <label class="list-group-item">
                                            <input class="form-check-input me-1" type="checkbox" name="furits[]" value="orange" <?php CheckedInput('furits', 'orange') ?> />
                                            Orange
                                        </label>
                                        <label class="list-group-item">
                                            <input class="form-check-input me-1" type="checkbox" name="furits[]" value="komola" <?php CheckedInput('furits', 'komola') ?> />
                                            Komola
                                        </label>
                                        <label class="list-group-item">
                                            <input class="form-check-input me-1" type="checkbox" name="furits[]" value="jackfurits" <?php CheckedInput('furits', 'jackfurits') ?> />
                                            Jackfurits
                                        </label>
                                    </div>
                                </div>
